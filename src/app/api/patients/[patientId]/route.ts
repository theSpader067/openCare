  ...
  try {
    ...
    const updatedPatient = await prisma.patient.update({
      ...
      data: {
        ...
        ...(motif !== undefined && { motif: motif ? motif.trim() : "" }),
        ...
        ...(atcdsGynObstetrique !== undefined && { atcdsGynObstetrique: atcdsGynObstetrique ? atcdsGynObstetrique.trim() : "" }),
        ...(atcdsFamiliaux !== undefined && { atcdsFamiliaux: atcdsFamiliaux ? atcdsFamiliaux.trim() : "" }),
        ...(addressOrigin !== undefined && { addressOrigin: addressOrigin ? addressOrigin.trim() : "" }),
        ...(addressHabitat !== undefined && { addressHabitat: addressHabitat ? addressHabitat.trim() : "" }),
        ...(couvertureSociale !== undefined && { couvertureSociale: couvertureSociale ? couvertureSociale.trim() : "" }),
        ...(situationFamiliale !== undefined && { situationFamiliale: situationFamiliale ? situationFamiliale.trim() : "" }),
        ...(profession !== undefined && { profession: profession ? profession.trim() : "" }),
